export const tabInfo = {
  qc: {
    ...
    content: "Welcome to the Quality Control tab.\n\n" +
  ...
  interactive: {
    ...
    content: "Welcome to the Interactive Explorer tab.\n\n" +
  ...
  multiplex: {
    ...
    content: "Welcome to the Multiplex Overlay tab.\n\n" +
  ...
  stats: {
    ...
    content: "Welcome to the Spatial Statistics tab.\n\n" +
  ...
  tf: {
    ...
    content: "Welcome to the Transcription Factor Analysis tab.\n\n" +
  ...
  ccc: {
    ...
    content: "Welcome to the Cell-Cell Communication tab.\n\n" +
  ...
  annotation: {
    ...
    content: "Welcome to the Cell Type Annotation tab.\n\n" +
  ...
  deAnalysis: {
    ...
    content: "Welcome to the Differential Expression Analysis tab.\n\n" +
  ...
  conditionsDe: {
    ...
    content: "Welcome to the Conditions DE tab.\n\n" +
