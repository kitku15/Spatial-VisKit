...
import { ANALYSIS_NAME, largeColorPalette, themeColors } from './config';
        ...
        <div className="flex-1 p-4">
          <Plot
            ...
            layout={{ 
              ...
              yaxis: { title: 'g(r)', rangemode: 'tozero', gridcolor: themeColors.stroke },
              shapes: [{
    ...
    <div className="p-6 flex flex-col gap-4 h-full bg-app">
      <div className="bg-panel p-4 border border-borderLight shadow-sm rounded flex flex-col xl:flex-row justify-between items-center gap-4">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <h2 className="text-xl font-bold text-textMain border-r border-borderMain pr-4">Spatial Analytics</h2>
          ...
          <div className="flex gap-2 bg-borderLight p-1 rounded">
            {[
              ...
              <button
                ...
                className={`px-4 py-2 rounded text-sm font-semibold transition ${activeTab === tab.id ? 'bg-panel shadow text-primary' : 'text-textMuted hover:bg-borderMain hover:text-textMain'}`}
              >
                {tab.label}
              </button>
            ))}
